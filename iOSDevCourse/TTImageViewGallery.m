...
@interface TTImageViewGallery () <MHFacebookImageViewerDatasource>
...
@implementation TTImageViewGallery
...
- (instancetype) initWithImageArray:(NSArray *)imageArray startPoint:(CGPoint)point {
    ...
    if (self) {
        ...
        for (id Obj in self.images) {
            ...
            if ([Obj isKindOfClass:[TTPhoto class]]) {
                
                TTPhoto *imageObj = (TTPhoto *)Obj;
...
-  (NSURL*) imageURLAtIndex:(NSInteger)index imageViewer:(MHFacebookImageViewer *)imageViewer {
    ...
    if ([[self.images objectAtIndex:index] isKindOfClass:[TTPhoto class]]) {
        TTPhoto *photo = [self.images objectAtIndex:index];
